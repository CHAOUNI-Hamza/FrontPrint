                        ...
                        <div class="dropdown cart-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <div class="dropdown-cart-action">
                                    <a href="cart.html" class="btn btn-primary">Voir le panier</a>
                                    <a href="checkout.html" class="btn btn-outline-primary-2"><span>Vérifier</span><i class="icon-long-arrow-right"></i></a>
                                </div><!-- End .dropdown-cart-total -->
